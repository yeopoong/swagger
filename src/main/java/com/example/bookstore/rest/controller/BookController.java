...
import com.example.bookstore.rest.BookResourceAssembler;
import com.example.bookstore.rest.domain.BookResource;
import com.example.bookstore.rest.exception.ResourceNotFoundException;
...
//	}
	...
	public BookResource getBook(@PathVariable("id") Long id) {
		...
		Link link = new Link("http://localhost:8080/rest/books/1/reviews", "reviews");
		resource.add(link);
		return resource;
	}
